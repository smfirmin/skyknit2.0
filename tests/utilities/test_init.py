...
import skyknit.utilities as utilities
...
class TestPublicAPI:
    ...
    def test_gauge_importable(self):
        from skyknit.utilities import Gauge
    ...
    def test_shaping_action_importable(self):
        from skyknit.utilities import ShapingAction
    ...
    def test_shaping_interval_importable(self):
        from skyknit.utilities import ShapingAction, ShapingInterval
    ...
    def test_conversion_functions_importable(self):
        from skyknit.utilities import inches_to_mm, mm_to_inches

        assert inches_to_mm(1.0) == 25.4
        assert mm_to_inches(25.4) == 1.0

    def test_tolerance_functions_importable(self):
        from skyknit.utilities import Gauge, PrecisionLevel, calculate_tolerance_mm
    ...
    def test_repeat_functions_importable(self):
        from skyknit.utilities import find_valid_counts, select_stitch_count
    ...
    def test_pipeline_function_importable(self):
        from skyknit.utilities import Gauge, select_stitch_count_from_physical
    ...
    def test_shaping_function_importable(self):
        from skyknit.utilities import calculate_shaping_intervals
